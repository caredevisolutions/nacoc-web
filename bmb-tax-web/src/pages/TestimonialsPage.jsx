            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {testimonials.map((t, idx) => (
                    <motion.div
                        ...
                        whileHover={{ y: -10 }}
                        className="bg-slate-900 p-8 rounded-2xl border border-slate-800 transition-all duration-300 relative group cursor-pointer hover:shadow-xl hover:border-gold-DEFAULT/30"
                    >
             ...
             <motion.div 
                ...
                className="mt-20 text-center bg-slate-900 rounded-3xl p-12 relative overflow-hidden border border-slate-800 shadow-xl"
            >
                ...
                <p className="text-slate-300 text-lg mb-10 max-w-xl mx-auto relative z-10 font-medium">Experience the difference of a dedicated financial partner.</p>
